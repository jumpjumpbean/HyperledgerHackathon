...
-->
      ...
      <!-- 
        ...
        @current-change="handleClickCurrentRowToSelected" 
        点击单列加亮和选择
      -->
      <el-table
        :data="users"
...
export default {
  ...
  methods: {
    ...
    handleClickCurrentRowToSelected(currentRow, oldCurrentRow) {
      currentRow.multipleSelection = true;
      oldCurrentRow.multipleSelection = true;
    },
